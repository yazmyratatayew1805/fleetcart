<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::text('translatable[paystack_label]', trans('setting::attributes.paystack_label'), $errors, $settings, ['required' => true]) }}
        {{ Form::textarea('translatable[paystack_description]', trans('setting::attributes.paystack_description'), $errors, $settings, ['rows' => 3, 'required' => true]) }}
        ...
        <div class="{{ old('paystack_enabled', array_get($settings, 'paystack_enabled')) ? '' : 'hide' }}" id="paystack-fields">
            {{ Form::text('paystack_secret_key', trans('setting::attributes.paystack_secret_key'), $errors, $settings, ['required' => true]) }}
        </div>
    </div>
</div>
